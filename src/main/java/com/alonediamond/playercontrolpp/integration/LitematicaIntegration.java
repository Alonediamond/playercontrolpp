...
public class LitematicaIntegration implements ModIntegration {
     ...
     * Uses getDeclaredField with setAccessible because the field is
     * {@code protected} in MaterialListBase (1.21.11+).
     */
    @SuppressWarnings("unchecked")
    public Set<Object> getIgnoredSet(Object materialList) {
        try {
            java.lang.reflect.Field field = materialList.getClass().getDeclaredField("ignored");
        ...
        try {
            ...
            if (showActionBar) {
                ...
                if (client.player != null) {
                    ...
                    PlayerCompat.sendOverlayMessage(client.player, Component.nullToEmpty(msg));
                }
            }
            return true;
        } catch (Exception e) {
